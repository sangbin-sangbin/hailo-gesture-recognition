        ...
        for region in regions:
            ...
            with InferVStreams(self.hand_network_group, self.hand_input_vstreams_params, self.hand_output_vstreams_params) as hand_infer_pipeline:
                ...
                with self.hand_network_group.activate(self.hand_network_group_params):
                    lm_infer_results = hand_infer_pipeline.infer(input_data)

                    lm_result_1 = lm_infer_results[self.hand_output_vstream_info_1.name]
                    lm_result_2 = lm_infer_results[self.hand_output_vstream_info_2.name]
                    lm_result_3 = lm_infer_results[self.hand_output_vstream_info_3.name]
                    lm_result_4 = lm_infer_results[self.hand_output_vstream_info_4.name]
                    lm_result = {self.lm_score: lm_result_2, self.lm_handedness: lm_result_3, self.lm_landmarks: lm_result_1}
